...
class Payer_Masterpass_Functions {
    ...
    public function add_button() {
        ...
        if ( 'yes' === $payer_masterpass_settings['instant_masterpass_checkout'] ) {
            echo '<object type="image/svg" class="payer_instant_checkout" id="payer_instant_checkout"><img class="payer_instant_checkout" src="https://static.masterpass.com/dyn/img/btn/global/mp_chk_btn_147x034px.svg" alt="MasterPass"/> </object>';
        }
    }
