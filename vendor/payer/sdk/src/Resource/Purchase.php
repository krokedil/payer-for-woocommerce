...
class Purchase extends PayerResource {
	...
	public function create( array $input ) {
		...
		<body>
		<form id="order_form" 	 name="order_form"         	action="<?php echo $post->get_server_url(); ?>" method="post">
			<input type="hidden" name="payer_agentid" 		value="<?php echo $post->get_agentid(); ?>" />
			<input type="hidden" name="payer_xml_writer" 	value="<?php echo $post->get_api_version(); ?>" />
			<input type="hidden" name="payer_data" 			value="<?php echo $post->get_xml_data(); ?>" />
			<input type="hidden" name="payer_checksum" 		value="<?php echo $post->get_checksum(); ?>" />
			<input type="hidden" name="payer_charset" 		value="<?php echo $post->get_charset(); ?>" />
		</form>
		</body>
		</html>
		<?php
